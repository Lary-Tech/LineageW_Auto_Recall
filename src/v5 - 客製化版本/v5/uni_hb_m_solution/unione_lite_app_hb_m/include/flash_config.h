...
#define EF_START_ADDR                  (2*1024*1024-64*1024)  //0x1f0000~0x200000
#define STUDY_GRAMMAR_ADDR             (EF_START_ADDR - 32*1024)  //0x1e8000~0x1f0000
#define STUDY_MERGED_GRAMMAR_ADDR      (STUDY_GRAMMAR_ADDR - 32*1024)  //0x1e0000~0x1e8000
#define STUDY_TMP_GRAMMAR_NODE_ADDR    (STUDY_MERGED_GRAMMAR_ADDR - 64*1024)  //0x1d0000~0x1e0000
